...
public class ImplementQueueUsingStacks {
    ...
    /**
     * 将一个栈当作输入栈，用于压入 push 传入的数据；另一个栈当作输出栈，用于 \texttt{pop}pop 和 \texttt{peek}peek 操作。
     * <p>
    ...
    class MyQueue {
        ...
        public int peek() {
            ...
            return outStack != null && outStack.peek() != null ? outStack.peek() : -1;
        }
